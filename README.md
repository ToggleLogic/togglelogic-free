...
- **Skill-aware routing (1.7.3).** A guaranteed pre-execution gate
...
Version 1.5.2 preserves the durable-family rule across skill routing and the
host's ordered model chain.
